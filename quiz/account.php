...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Contac us</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Quiz Master</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Lencoe and Chantelle</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">0721262590</h4>
		<h4 style="font-family:'typo' ">teamDEV@gmail.com</h4>
		<h4 style="font-family:'typo' ">HyperionDev </h4></div></div>
		</p>
      </div>
